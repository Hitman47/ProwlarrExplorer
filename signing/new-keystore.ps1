...
param(
    ...
    [string]$FileName = 'prowlarr-explorer.jks',
    [string]$Alias = 'prowlarr-explorer',
...
try {
    ...
    & $keytool -genkeypair `
        ...
        '-storepass:env' ZS_STORE_PW `
        '-keypass:env' ZS_KEY_PW
    ...
    Remove-Item Env:\ZS_STORE_PW -ErrorAction SilentlyContinue
    Remove-Item Env:\ZS_KEY_PW -ErrorAction SilentlyContinue
    $storePw = $null
    $keyPw = $null
    [GC]::Collect()
}
